...
## 1. 책 데이터 분석 작업흐름 {#hq-book-workflow}
...
## 3. 저녁이 있는 삶  {#hq-evening-with-life}
...
## 4. 저녁이 있는 삶 - 형태소 분석 {#hq-evening-with-life-words}
...
## 5. 단어구름을 이미지와 결합 {#hq-evening-with-life-wordcloud}
...
``` {r hq-book-wordcloud2, eval=FALSE}
# 1. 텍스트 전처리 함수
