...
## 트위터 계정과 핸드폰 번호 등록 {#nlp-twitter-setup}
...
## 트위터 개발자 페이지 {#nlp-twitter-developer}
...
## 키값과 접속 토큰 {#nlp-twitter-developer-token}
...
# `twitteR` 트위터 데이터 긁어오기 {#nlp-twitter-api}
...
# 단어문서행렬 {#nlp-twitter-tdm}

## 트위터 인증 {#nlp-twitter-tdm-auth}
...
## 트위터 데이터 불러오기 {#nlp-twitter-tdm-import}
...
## 트위터 데이터 전처리 {#nlp-twitter-tdm-preprocessing}
...
## 빈도수 분석 및 시각화 {#nlp-twitter-tdm-barplot}
