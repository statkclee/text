...
### 2. `tm`, `qdap` 데이터 정제 기능 {#nlp-tm-qdap-cleansing}
...
### 2.2. 텍스트에서 말뭉치(Corpus)로 변환 {#nlp-r-text2corpus}
...
### 2.3. 말뭉치 정제  {#nlp-r-corpus-cleansing}
...
### 2.4. 단어문서행렬(Term Document Matrix, TDM) {#nlp-r-corpus-tdm}
