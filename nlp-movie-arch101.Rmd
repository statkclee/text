...
### 1.1. 환경설정 및 데이터 가져오기 {#nlp-arch-101-import}
...
### 1.2. 데이터 정제 {#nlp-arch-101-preprocessing}
...
### 1.3. 정규식 적용 등장배우 추출 {#nlp-arch-101-extract-char}
...
### 1.4. 통계작업과 등장배우 추출 {#nlp-arch-101-char-stat}
